    ...
    <body class="hold-transition sidebar-mini sidebar-collapse layout-fixed">
        <div class="wrapper">
            ...
            <div class="preloader flex-column justify-content-center align-items-center">
                <img class="animation__shake" src="{{Storage::url('asset/logo/logo-150px.png')}}" alt="FoodTo"
                    height="60" width="60">
            </div>

            <!--Header -->
            @include('layouts.rider.body.header')

            <!--Sidebar -->
            @include('layouts.rider.body.sidebar')
            ...
            <!--Footer -->
            @include('layouts.rider.body.footer')
