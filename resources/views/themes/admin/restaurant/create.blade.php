...
<div class="content-wrapper">
    ...
    <x-admin-content-header title="Add Restaurant" />

    <section class="content">
        <div class="container-fluid">
            <form class="mb-5" action="{{route('admin.restaurant.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-5">
                    <!-- Left Side -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="trade_name"
                                                placeholder="Trade Name" value="{{old('trade_name')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="owner_name"
                                                placeholder="Name" value="{{old('owner_name')}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for=""> Phone <span class="text-danger">*</span></label>
                                            <input required type="text" class="form-control" name="owner_phone"
                                                placeholder="Phone" value="{{old('owner_phone')}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="owner_alt_phone"
                                                placeholder="Alternate Phone" value="{{old('owner_alt_phone')}}">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input onchange="loadFile(event)" name="owner_image" type="file"
                                                    class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">Choose file</label>
                                            </div>
                                            <x-error name="owner_image" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_open[Sunday]" class="form-control">
                                            </div>
                                        </div>
                                        <!--Close-->
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_close[Sunday]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_open[Monday]" class="form-control">
                                            </div>
                                        </div>
                                        <!--Close-->
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_close[Monday]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_open[Tuesday]" class="form-control">
                                            </div>
                                        </div>
                                        <!--Close-->
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_close[Tuesday]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_open[Wednesday]" class="form-control">
                                            </div>
                                        </div>
                                        <!--Close-->
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_close[Wednesday]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_open[Thursday]" class="form-control">
                                            </div>
                                        </div>
                                        <!--Close-->
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_close[Thursday]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_open[Friday]" class="form-control">
                                            </div>
                                        </div>
                                        <!--Close-->
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_close[Friday]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_open[Saturday]" class="form-control">
                                            </div>
                                        </div>
                                        <!--Close-->
                                        <div class="timingInput col-md-4 col-sm-6 invisible">
                                            <div class="form-group">
                                                <input type="time" name="timing_close[Saturday]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
