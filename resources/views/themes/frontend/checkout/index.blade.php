                                    ...
                                    <div class="gold-members p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="text-black">291/d/1, 291, Jawaddi Kalan, Ludhiana,
                                                    Punjab
                                                    141002, India
                                                </p>
                                    ...
                                    <div class="gold-members p-4">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>Delhi Bypass Rd, Jawaddi Taksal, Ludhiana, Punjab 141002,
                                                    India
                                                </p>
                                                <p class="mb-0 text-black font-weight-bold"><a
                                                        class="btn btn-sm btn-secondary mr-2" href="#"> DELIVER
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="mb-0 text-black font-weight-bold"><a data-toggle="modal"
                                                        ...
                                                        class="btn btn-sm btn-primary mr-2" href="#"> ADD NEW
                                                        ADDRESS</a>
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-8 pl-0">
                                <div class="tab-content h-100" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                        ...
                                        <p>WE ACCEPT <span class="osahan-card">
                                                <i class="icofont-sage-alt"></i> <i class="icofont-stripe-alt"></i>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                        ...
                                        <div class="border shadow-sm-sm p-4 d-flex align-items-center bg-white mb-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <p class="card-text">Apple Pay lets you order now & pay later at
                                                    no
                                                    extra cost.</p>
                                        ...
                                        <div class="border shadow-sm-sm p-4 d-flex bg-white align-items-center mb-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <p class="card-text">Paypal lets you order now & pay later at no
                                                    extra cost.</p>
                                                <a href="#" class="card-link font-weight-bold">LINK ACCOUNT <i
                                                        class="icofont-link-alt"></i></a>
                                            </div>
                                        ...
                                        <div class="border shadow-sm-sm p-4 d-flex bg-white align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <p class="card-text">Diners Club lets you order now & pay later
                                                    at
                                                    no extra cost.</p>
                                                <a href="#" class="card-link font-weight-bold">LINK ACCOUNT <i
                                                        class="icofont-link-alt"></i></a>
                ...
                <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                    <div class="d-flex mb-4 osahan-cart-item-profile">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="mb-0 text-white"><i class="icofont-location-pin"></i> 2036 2ND AVE, NEW
                                YORK,
                                NY 10029</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-2 bg-white rounded p-2 clearfix">
                        ...
                        <div class="input-group mb-0">
                            ...
                            <textarea class="form-control" placeholder="Any suggestions? We will pass it on..."
